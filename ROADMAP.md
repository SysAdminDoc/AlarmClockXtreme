...
Living feature backlog, refreshed alongside **v1.11.4** (Play wake-lock
policy audit; see [CHANGELOG.md](CHANGELOG.md)). Last audit: **2026-05-16** —
...
> **Recently shipped** (rolled up from prior tiers): **v1.11.4 Play
> wake-lock policy audit (N4)**; **v1.11.3 App Standby bucket awareness
> (N3)**; **v1.11.2 telephony-aware alarm muting (N2)**; **v1.11.1
...
- **Targets:** `minSdk 26`, `targetSdk 35`, `compileSdk 36`,
  `versionCode 58`, `versionName 1.11.4`.
