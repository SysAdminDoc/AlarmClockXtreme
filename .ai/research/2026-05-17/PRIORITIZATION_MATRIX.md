...
| P0-4 | Room migration/schema gate | 4 | 5 | 2 | 2 | 5 | v10 schema export was added during the research pass; v1.13.7 adds v11 retry-count schema/migration coverage. |
...
| P1-6 | Local sleep/wake analytics charts | 4 | 4 | 3 | 2 | 3 | Shipped v1.13.7 with local Health Connect sleep/session correlation, wake response bars, snooze counts, and persisted challenge retries. |
| P1-7 | Media3/ExoPlayer audio path audit | 3 | 3 | 4 | 3 | -1 | Useful but less urgent than downloader security and release trust. |
...
| P2-3 | Local sleep trend charts | 3 | 4 | 3 | 2 | 2 | Shipped v1.13.7 in the active top queue. |
