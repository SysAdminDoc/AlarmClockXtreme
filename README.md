...
![Version](https://img.shields.io/badge/version-1.15.20-blue)
...
```
adb install AlarmClockXtreme-v1.15.20-play-release.apk
```
...
```bash
apksigner verify --print-certs AlarmClockXtreme-v1.15.20-play-release.apk
```
