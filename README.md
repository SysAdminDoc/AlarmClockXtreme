...
![Version](https://img.shields.io/badge/version-1.15.17-blue)
...
```
adb install AlarmClockXtreme-v1.15.17-play-release.apk
```
...
| Bedtime Tracking | Sleep goal, sleep cycle calculator, bedtime reminders, sleep sounds, and Android 16 final-hour bedtime countdown Live Updates |
...
```bash
apksigner verify --print-certs AlarmClockXtreme-v1.15.17-play-release.apk
```
