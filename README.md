...
![Version](https://img.shields.io/badge/version-1.15.32-blue)
...
```
adb install AlarmClockXtreme-v1.15.32-play-release.apk
```
...
```bash
apksigner verify --print-certs AlarmClockXtreme-v1.15.32-play-release.apk
```
