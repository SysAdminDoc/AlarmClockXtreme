...
![Version](https://img.shields.io/badge/version-1.14.17-blue)
...
```
adb install AlarmClockXtreme-v1.14.17-play.apk
```
...
```bash
apksigner verify --print-certs AlarmClockXtreme-v1.14.17-play-release.apk
```
