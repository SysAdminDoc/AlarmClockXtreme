...
![Version](https://img.shields.io/badge/version-1.14.7-blue)
...
```
adb install AlarmClockXtreme-v1.14.7-play.apk
```
...
```bash
apksigner verify --print-certs AlarmClockXtreme-v1.14.7-play-release.apk
```
