...
![Version](https://img.shields.io/badge/version-1.14.13-blue)
...
```
adb install AlarmClockXtreme-v1.14.13-play.apk
```
...
```bash
apksigner verify --print-certs AlarmClockXtreme-v1.14.13-play-release.apk
```
